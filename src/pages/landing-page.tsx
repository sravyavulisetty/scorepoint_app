...
import image from '../assets/selective-focus-shot-four-aces-wooden-table.jpg';
const Landingpage:React.FC = ()=>{
  return (
    <div className='flex gap-2 justify-between items-center h-screen'>
    <div className='pl-16'>
      <h1 className="font-semibold text-7xl">Ace Your Game Scores</h1>
      <h1 className='font-extralight text-2xl pt-6 font-poppins bg-bggradient text-transparent bg-clip-text'>Your Ultimate Scorekeeping Hub</h1>
      ...
      <div className='flex flex-row gap-1 items-center text-center pt-2 font-poppins font-light'><p className='pt-2 text-sm'>Don't have an account yet,  </p><Link to={'/signup'}><button className='text-md font-normal rounded px-3 mt-2 ml-2 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% p-1 transition duration-500 hover:scale-110'>Sign Up</button></Link></div>
    </div>
